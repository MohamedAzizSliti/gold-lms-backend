                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td class="message_contact" align="center"
                                        ...
                                        <multiline>
                                            <p>
                                                Nous vous souhaitons la bienvenue chez <strong>Gold GPS</strong> et vous remercions de nous avoir choisis comme solution de <strong>tracking GPS</strong> pour vos véhicules.
                                            </p>
                                            <p>
                                            ...
                                            <ul>
                                                <li>🔗 <strong>Lien : </strong><a href="https://gold-gps.bensassiridha.com/admin/">https://gold-gps.bensassiridha.com/admin/</a></li>
                                                <li>👤 <strong>Identifiant : </strong>bensassi</li>
                                                <li>🔑 <strong>Mot de passe : </strong>**********</li>
                                            </ul>
                                            <h3>Accès à l’application mobile</h3>

                                            <ul>
                                                <li>👤 <strong>Identifiant : </strong>92605444</li>
                                                <li>🔑 <strong>Mot de passe : </strong>**********</li>
                                            </ul>
                                            ...
                                            <div style="text-align: center">
                                                <div style="display: inline-block;width: 48%">
                                                    ...
                                                    <img src="{{url('/admin/img/email/qr_iphone.jpeg')}}" alt="">
                                                </div>
                                                <div  style="display: inline-block;width: 48%">
                                                    <span style="display: block;text-align: center;font-weight: bold">📱 Iphone (Apple) : </span>
                                                    <img src="{{url('/admin/img/email/qr_android.jpg')}}" alt="">
                                                </div>
                                            </div>
                                            <p>
                                                Si vous avez la moindre question, notre équipe reste à votre disposition pour vous accompagner.
                                            </p>
                                            <strong style="display: block;text-align: center">Bienvenue à bord et bonne utilisation de Gold GPS !</strong>
                                        </multiline>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr class="footer">
                                    <td align="center"
                                        ...
                                        <strong>Téléphone :</strong> +216 92 555 123
                                        <strong>Courriel:</strong> contact@gold-gps.com
                                    </td>
                                </tr>
                                <tr>
                                    <td height="25"><img
