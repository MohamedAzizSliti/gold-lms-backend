...
define("SERVER", "https://smsv2.mbh-fiduciaire.site");
define("API_KEY", "760207cd740e6f4fd33503873682e9e5032b04a5");

// to see the of used see smsv2.mbh-fiducaire.ch
class ApiSmsGateway  {

    // start with ero for index
    const ACTIVE_SIME = 0;
    const ACTIVE_DEVICE = 2;
