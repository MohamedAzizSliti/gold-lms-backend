...
class CompanyRegisterNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->line("Store Name: {$this->company->company_name}")
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'message' => "Exciting News! A new vendor, {$this->company->company_name}, has joined our website. Discover their incredible products and deals today. Also, stay tuned for updates on recent check request approvals and rejections.",
            'type' => "store"
        ];
    }
}
